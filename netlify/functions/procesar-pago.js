exports.handler = async function(event, context) {
  ...
  try {
    ...
    if (!mpResponse.ok) {
      // 👇 ESTA LÍNEA IMPRIMIRÁ EL ERROR EN NETLIFY 👇
      console.error("⛔ DETALLE DEL RECHAZO DE MERCADO PAGO:", JSON.stringify(mpResult));

      return {
        statusCode: 400,
        body: JSON.stringify({ error: "Error de Mercado Pago", detalle_mp: mpResult })
      };
    }
